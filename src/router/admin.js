...
router.post('/update-booking/:id', ensureIsAdmin, cw(adminPanelController.updateBooking));
router.post('/create-booking', ensureIsAdmin, cw(adminPanelController.createBooking));
